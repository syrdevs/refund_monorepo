...
export function loginSaga() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, takeLatest(LOGIN_REQUESTED, tryLogin)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
export function checkAuthTokenSaga() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, takeLatest(CHECK_AUTH_TOKEN, checkAuthToken)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
export function logoutSaga() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, takeLatest(LOGOUT, logout)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
