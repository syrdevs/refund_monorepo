...
var ProtocolItemsTable = styled(Table)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  .ant-table td {\n    white-space: nowrap;\n  }\n"], ["\n  .ant-table td {\n    white-space: nowrap;\n  }\n"])));
    ...
    function ProtocolActivitiesTable(props) {
        ...
        _this.fetchProtocolItems = function (activityId, page, pageSize) {
            return createApiClient()
                ...
                .catch(function (error) { return message.error(error.response && error.response.statusText); });
        };
        ...
        _this.saveDataPage = function (activityId) {
            ...
            return Promise.all(pageData.map(function (i) { return createApiClient().savePlanProtocolItem(i); }));
        };
        ...
        _this.onDataOnPageSave = function (activityId) {
            _this.saveDataPage(activityId)
                ...
                .catch(function (error) { return message.error('Ошибка при сохранении страницы протокола'); });
        };
        _this.onDataOnRowSave = function (activityId, clinicId) {
            _this.saveDataRow(activityId, clinicId)
                ...
                .catch(function (error) { return message.error('Ошибка при сохранении строки протокола'); });
        };
        ...
        _this.doPostAction = function (activityId, postAction) {
            if (!_this.checkForLosingChangedCellValues(activityId)) {
                var modalInfo = CreateYesNoModalInfo('Предупреждение', 'У вас есть несохраненные данные. Вы действительно хотите продолжить?', function () {
                    postAction();
            ...
            return [
                ...
                },
                {
                    ...
                    render: function (id, originalRow) {
                        return (originalRow.initialCellValues.some(function (i) { return i.dirty; }) && (React.createElement(Icon, { type: "check", style: { color: '#1890ff', cursor: 'pointer' }, onClick: function () { return _this.onDataOnPageSave(originalRow.activity.id); } })));
                    },
                },
            ];
        };
...
var mapDispatchToProps = function (dispatch) {
    return {
        fetchCustomDict: function (dictNames) { return dispatch(fetchCustomDict(dictNames)); },
...
export default connect(mapStateToProps, mapDispatchToProps)(ProtocolActivitiesTable);
