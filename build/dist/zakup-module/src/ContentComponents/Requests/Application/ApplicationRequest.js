...
var ApplicationRequest = /** @class */ (function (_super) {
        ...
        _this.getObjectById = function (id) {
            createApiClient()
                ...
                var application = {
                    ...
                    clinic: data.clinic,
                    region: data.region,
                    role: AppRolesDict.find(function (i) { return i.id === "" + data.role; }),
                };
    ...
    ApplicationRequest.prototype.render = function () {
        ...
        return (React.createElement(ContentLayout, { contentName: header, breadcrumbRoutes: bcRoutes, entity: "app", disableCommands: id === 'new', showCommands: true, onCommandClick: this.onCommandClick },
            React.createElement(Tabs, { tabPosition: "left", size: "small" },
                React.createElement(TabPane, { tab: "\u0422\u0438\u0442\u0443\u043B\u044C\u043D\u0430\u044F \u0447\u0430\u0441\u0442\u044C", key: "1" },
                    React.createElement(ApplicationRequestInternalForm, __assign({}, fields, { valid: valid, isNew: id === 'new', hasItems: this.state.applicationItems.length > 0, onChange: this.handleFormChange, handleSubmit: this.handleSubmit, clinicsDict: this.state.clinicsDict, regionsDict: this.props.regionsDict, onSendToReview: this.onSendToReview }))),
                React.createElement(TabPane, { tab: "\u0421\u043F\u0435\u0446\u0438\u0444\u0438\u043A\u0430\u0446\u0438\u044F", key: "2" },
                    React.createElement(ApplicationRequestActivitiesTable, { applicationItems: applicationItems, allActivities: this.state.activities, onApplicationItemsChange: this.onApplicationItemsChange })),
