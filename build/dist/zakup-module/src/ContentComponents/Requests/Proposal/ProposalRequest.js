...
var ProposalRequest = /** @class */ (function (_super) {
    ...
    function ProposalRequest(props) {
        ...
        _this.onCommandClick = function (commandId, isReport) {
            createApiClient().runCommand(commandId, [_this.props.id], isReport);
        };
        ...
        _this.handleSubmit = function (form) { return function (e) {
            ...
            form.validateFields(function (err, values) {
                if (!err) {
                    ...
                    var apiClient_1 = createApiClient();
                    apiClient_1
                        ...
                        .catch(function (error) { return message.error('Ошибка при сохранении заявки'); });
                }
            });
        }; };
...
export default connect(mapStateToProps, mapDispatchToProps)(ProposalRequest);
