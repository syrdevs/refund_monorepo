                ...
                return (
                  ...
                  >
                    {this.props.form.getFieldDecorator("identitytype" + record.key, {
                      ...
                      <Select name={"identitytype" + record.key} style={{ width: 250 }} onChange={(e) => {
                ...
                return (
                  ...
                  >
                    {this.props.form.getFieldDecorator("identityname" + record.key, {
                      ...
                      <Input name={"identityname" + record.key} onChange={(e) => {
                ...
                return (
                  ...
                  >
                    {this.props.form.getFieldDecorator("identitybeginDate" + record.key, {
                      ...
                      <DatePicker style={{ width: "100%" }} name={"identitybeginDate" + record.key}
                                  format={"DD.MM.YYYY"} onChange={(e) => {
              ...
              render: (text, record) => {
                ...
                >
                  {this.props.form.getFieldDecorator("identityendDate" + record.key, {
                    ...
                    <DatePicker style={{ width: "100%" }} name={"identityendDate" + record.key} format={"DD.MM.YYYY"}
                                onChange={(e) => {
                ...
                return (
                  ...
                  >
                    {this.props.form.getFieldDecorator("adresstype" + record.key, {
                      ...
                      <Input name={"adresstype" + record.key} onChange={(e) => {
                        this.identValue(e.target.value, record, "adresstype", "adresses");
                      }}/>)}
                  </FormItem>);
              }
            },
              ...
              return (
                ...
                >
                  {this.props.form.getFieldDecorator("contacttype" + record.key, {
                    ...
                    <Input name={"contacttype" + record.key} onChange={(e) => {
                      this.identValue(e.target.value, record, "contacttype", "contacts");
                    }}/>)}
                </FormItem>);
            }
          },
                ...
                return (
                  ...
                  >
                    {this.props.form.getFieldDecorator("bik" + record.key, {
                      ...
                      <Input name={"bik" + record.key} onChange={(e) => {
                        this.identValue(e.target.value, record, "bik", "banks");
                      }}/>)}
                  </FormItem>);
              }
            },
                ...
                return (
                  ...
                  >
                    {this.props.form.getFieldDecorator("bankname" + record.key, {
                      ...
                      <Input name={"bankname" + record.key} onChange={(e) => {
                        this.identValue(e.target.value, record, "bankname", "banks");
                      }}/>)}
                  </FormItem>);
              }
            },
                ...
                return (
                  ...
                  >
                    {this.props.form.getFieldDecorator("position" + record.key, {
                      ...
                      <Input name={"position" + record.key} onChange={(e) => {
                        this.identValue(e.target.value, record, "position", "responses");
                      }}/>)}
                  </FormItem>);
              }
            },
                ...
                return (
                  ...
                  >
                    {this.props.form.getFieldDecorator("surname" + record.key, {
                      ...
                      <Input name={"surname" + record.key} onChange={(e) => {
                        this.identValue(e.target.value, record, "surname", "responses");
                      }}/>)}
                  </FormItem>);
              }
            },
                ...
                return (
                  ...
                  >
                    {this.props.form.getFieldDecorator("name" + record.key, {
                      ...
                      <Input name={"name" + record.key} onChange={(e) => {
                        this.identValue(e.target.value, record, "name", "responses");
                      }}/>)}
                  </FormItem>);
              }
            },
                ...
                return (
                  ...
                  >
                    {this.props.form.getFieldDecorator("patronic" + record.key, {
                      ...
                      <Input name={"patronic" + record.key} onChange={(e) => {
                        this.identValue(e.target.value, record, "patronic", "responses");
                      }}/>)}
                  </FormItem>);
              }
            },
              ...
              render: (text, record) => {
                ...
                >
                  {this.props.form.getFieldDecorator("bdate" + record.key, {
                    ...
                    <DatePicker style={{ width: "100%" }} name={"bdate" + record.key} format={"DD.MM.YYYY"}
                                onChange={(e) => {
                                  this.identValue(e, record, "bdate", "responses");
                                }}/>
                  )}
                </FormItem>);
              }
                ...
                return (
                  ...
                  >
                    {this.props.form.getFieldDecorator("fio_parently_initials" + record.key, {
                      ...
                      <Input name={"fio_parently_initials" + record.key} onChange={(e) => {
                        this.identValue(e.target.value, record, "fio_parently_initials", "responses");
                      }}/>)}
                  </FormItem>);
              }
            },
                ...
                return (
                  ...
                  >
                    {this.props.form.getFieldDecorator("fio_genitive_initials" + record.key, {
                      ...
                      <Input name={"fio_genitive_initials" + record.key} onChange={(e) => {
                        this.identValue(e.target.value, record, "fio_genitive_initials", "responses");
                      }}/>)}
                  </FormItem>);
              }
            },
              ...
              render: (text, record) => {
                ...
                >
                  {this.props.form.getFieldDecorator("registrbeginDate" + record.key, {
                    ...
                    <DatePicker style={{ width: "100%" }} name={"registrbeginDate" + record.key} format={"DD.MM.YYYY"}
                                onChange={(e) => {
                                  this.identValue(e, record, "registrbeginDate", "RegistrerSZs");
                                }}/>
                  )}
                </FormItem>);
              }
              ...
              render: (text, record) => {
                ...
                >
                  {this.props.form.getFieldDecorator("registrendDate" + record.key, {
                    ...
                    <DatePicker style={{ width: "100%" }} name={"registrendDate" + record.key} format={"DD.MM.YYYY"}
                                onChange={(e) => {
                                  this.identValue(e, record, "registrendDate", "RegistrerSZs");
                                }}/>
                  )}
                </FormItem>);
              }
                ...
                return (
                  ...
                  >
                    {this.props.form.getFieldDecorator("registr_reason" + record.key, {
                      ...
                      <Input name={"registr_reason" + record.key} onChange={(e) => {
                        this.identValue(e.target.value, record, "registr_reason", "RegistrerSZs");
                      }}/>)}
                  </FormItem>);
              }
            },
            ...
            <div style={{ marginTop: "20px" }}>
              ...
              >
                {getFieldDecorator("codeagent", {
                  ...
                  <Input style={titledata} name='codeagent' onChange={(e) => {
                    this.mainfiels(e);
            ...
            <div style={{ margin: "0px 20px 0px 20px" }}>
              ...
              >
                {smarttabs.map(smarttab => {
                  return (
                    <TabPane tab={
                      <Badge count={this.state[smarttab.name + "count"]} style={{ backgroundColor: "#1990FF" }}>
