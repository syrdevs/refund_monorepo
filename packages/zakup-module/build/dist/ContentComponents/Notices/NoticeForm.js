...
var CustomizedForm = antd_1.Form.create({
    ...
    mapPropsToFields: function (props) {
        return {
            name: antd_1.Form.createFormField(__assign({}, props.name, { value: props.name.value ? props.name.value.id : '' })),
            region: antd_1.Form.createFormField(__assign({}, props.region, { value: props.region.value ? props.region.value.id : '' })),
            periodYear: antd_1.Form.createFormField(__assign({}, props.periodYear, { value: props.periodYear.value ? props.periodYear.value.id : '' })),
            dateBegin: antd_1.Form.createFormField(__assign({}, props.dateBegin, { value: props.dateBegin.value })),
            dateEnd: antd_1.Form.createFormField(__assign({}, props.dateEnd, { value: props.dateEnd.value })),
            noticeMedicalTypes: antd_1.Form.createFormField(__assign({}, props.noticeMedicalTypes, { value: props.noticeMedicalTypes && props.noticeMedicalTypes.value.map(function (i) { return i.medicalType.id; }) })),
            noticeMedicalForms: antd_1.Form.createFormField(__assign({}, props.noticeMedicalForms, { value: props.noticeMedicalForms && props.noticeMedicalForms.value.map(function (i) { return i.medicalForm.id; }) })),
        };
    },
})(function (props) {
    ...
    return (React.createElement(antd_1.Form, { onSubmit: props.handleSubmit(props.form), style: { display: 'flex', flexDirection: 'column' } },
        React.createElement(FormItem, __assign({ style: { marginBottom: '0', flexShrink: 0 }, label: "\u041D\u0430\u0438\u043C\u0435\u043D\u043E\u0432\u0430\u043D\u0438\u0435 \u043E\u0431\u044A\u044F\u0432\u043B\u0435\u043D\u0438\u044F" }, shared_1.CommonFormItemLayout), getFieldDecorator('name', {
            rules: [{ required: true, message: 'Поле обязательно для заполнения' }],
        })(React.createElement(antd_1.Select, null, props.namesDict.map(function (option) {
        ...
        React.createElement(FormItem, __assign({ style: { marginBottom: '0', flexShrink: 0 }, label: "\u041F\u043B\u0430\u043D\u043E\u0432\u044B\u0439 \u043F\u0435\u0440\u0438\u043E\u0434" }, shared_1.CommonFormItemLayout), getFieldDecorator('periodYear', {
            rules: [{ required: true, message: 'Поле обязательно для заполнения' }],
        })(React.createElement(antd_1.Select, null, props.periodYearsDict.map(function (option) {
            return React.createElement(Option, { key: option.id }, option.year);
        })))),
        React.createElement(FormItem, __assign({ style: { marginBottom: '0', flexShrink: 0 }, label: "\u0414\u0430\u0442\u0430 \u043D\u0430\u0447\u0430\u043B\u0430 \u043F\u0440\u0438\u0435\u043C\u0430 \u0437\u0430\u044F\u0432\u043E\u043A" }, shared_1.CommonFormItemLayout), getFieldDecorator('dateBegin', {
            rules: [{ required: true, message: 'Поле обязательно для заполнения' }],
        })(React.createElement(antd_1.DatePicker, { showTime: true, format: "DD.MM.YYYY HH:mm", disabledDate: utils_1.isDisabledPreviousDate, disabledTime: utils_1.isDisabledPreviousTime }))),
        React.createElement(FormItem, __assign({ style: { marginBottom: '0', flexShrink: 0 }, label: "\u0414\u0430\u0442\u0430 \u043E\u043A\u043E\u043D\u0447\u0430\u043D\u0438\u044F \u043F\u0440\u0438\u0435\u043C\u0430 \u0437\u0430\u044F\u0432\u043E\u043A" }, shared_1.CommonFormItemLayout), getFieldDecorator('dateEnd', {
            rules: [{ required: true, message: 'Поле обязательно для заполнения' }],
        })(React.createElement(antd_1.DatePicker, { showTime: true, format: "DD.MM.YYYY HH:mm", disabledDate: utils_1.isDisabledPreviousDate, disabledTime: utils_1.isDisabledPreviousTime }))),
        React.createElement(FormItem, __assign({ style: { marginBottom: '0', flexShrink: 0 }, label: "\u0412\u0438\u0434 \u043C\u0435\u0434\u0438\u0446\u0438\u043D\u0441\u043A\u043E\u0439 \u043F\u043E\u043C\u043E\u0449\u0438" }, shared_1.CommonFormItemLayout), getFieldDecorator('noticeMedicalTypes', {
            rules: [{ required: true, message: 'Поле обязательно для заполнения' }],
        })(React.createElement(antd_1.Select, { mode: "multiple" }, props.noticeMedicalTypesDict.map(function (option) {
            return React.createElement(Option, { key: option.id }, option.nameRu);
        })))),
        React.createElement(FormItem, __assign({ style: { marginBottom: '0', flexShrink: 0 }, label: "\u0424\u043E\u0440\u043C\u0430 \u043C\u0435\u0434\u0438\u0446\u0438\u043D\u0441\u043A\u043E\u0439 \u043F\u043E\u043C\u043E\u0449\u0438" }, shared_1.CommonFormItemLayout), getFieldDecorator('noticeMedicalForms', {
            rules: [{ required: true, message: 'Поле обязательно для заполнения' }],
        })(React.createElement(antd_1.Select, { mode: "multiple" }, props.noticeMedicalFormsDict.map(function (option) {
            return React.createElement(Option, { key: option.id }, option.nameRu);
        })))),
        React.createElement("div", { style: { display: 'flex', justifyContent: 'flex-end', marginTop: '10px', flexShrink: 0 } },
            React.createElement(antd_1.Button, { style: { marginRight: 5 }, type: "primary", htmlType: "button", disabled: !props.id.value || !props.isOpen, onClick: function () {
                    ...
                    history_1.getHistory().push(shared_ui_1.buildAppRoute(utils_1.getAppRoute(), '/requests/proposals/new'));
                } }, "\u0421\u043E\u0437\u0434\u0430\u0442\u044C \u0437\u0430\u044F\u0432\u043A\u0443 \u043D\u0430 \u043E\u0431\u044A\u0435\u043C\u044B"),
            React.createElement(antd_1.Button, { style: { marginRight: 5 }, type: "primary", htmlType: "button", disabled: !props.id.value || !props.hasApplications || !props.isOpen, onClick: function () { return props.createProtocol(props.id.value); } }, "\u0421\u0444\u043E\u0440\u043C\u0438\u0440\u043E\u0432\u0430\u0442\u044C \u043F\u0440\u043E\u0442\u043E\u043A\u043E\u043B"),
...
var NoticeForm = /** @class */ (function (_super) {
    ...
    function NoticeForm(props) {
            ...
            form.validateFields(function (err, values) {
                ...
                if (!err) {
                    ...
                    utils_1.createApiClient()
                        ...
                        antd_1.message.success('Объявление сохранено!');
                        _this.fetchEntity(newId);
                        // getHistory().push(buildAppRoute(getAppRoute(), `/notices/${newId}`))
                    })
                        .catch(function (error) { return antd_1.message.error('Ошибка при сохранении объявления'); });
                }
            });
        }; };
        ...
        _this.createProtocol = function (noticeId) {
            utils_1.createApiClient()
                ...
                .then(function () {
                antd_1.message.success('Протокол сформирован!');
            })
                .catch(function (error) {
                antd_1.message.error((error.message && error.response.data && error.response.data.Message) || 'Ошибка при формировании протокола');
            });
        };
    ...
    NoticeForm.prototype.render = function () {
        ...
        if (fetchSingleNoticeStatus === businessDataStateConstants_1.FETCH_ENTITY_STATUS.FETCHING || dictsFetching || !periodYearsDict.length) {
            return React.createElement(shared_1.ContentLayout, { contentName: header });
        }
        if (fetchSingleNoticeStatus === businessDataStateConstants_1.FETCH_ENTITY_STATUS.IDLE) {
            return null;
        }
        if (fetchSingleNoticeStatus === businessDataStateConstants_1.FETCH_ENTITY_STATUS.FAILED) {
            var modalInfo_1 = OkModalInfo_1.default('Ошибка при загрузке объявления', 'Объявление не найдено', function () {
        ...
        return (React.createElement(shared_1.ContentLayout, { contentName: header, breadcrumbRoutes: bcRoutes, entity: "notice", disableCommands: id === 'new', showCommands: true, onCommandClick: this.onCommandClick },
...
var mapDispatchToProps = function (dispatch) {
    return {
        fetchSingleNotice: function (id) { return dispatch(businessDataStateActions_1.fetchSingleNotice(id)); },
        setNewAd: function () { return dispatch({ type: businessDataStateConstants_1.SET_NEW_NOTICE_REQUESTED, payload: undefined }); },
    };
};
exports.default = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(NoticeForm);
