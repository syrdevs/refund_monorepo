...
var ApplicationRequestActivitiesTable = /** @class */ (function (_super) {
            ...
            return [
                {
                    ...
                    render: function (data, originalRow, index) {
                        ...
                        return (react_1.default.createElement("div", { style: { display: 'flex', alignItems: 'center' } },
                            react_1.default.createElement(antd_1.Select, { value: _this.props.applicationItems[idInChange].activity.id, onChange: function (val) {
                ...
                },
                {
                    ...
                    render: function (id, originalRow, index) {
                        ...
                        return (react_1.default.createElement("div", { style: { display: 'flex', alignItems: 'center' } },
                            react_1.default.createElement(antd_1.Icon, { style: { color: '#1890ff', cursor: 'pointer' }, type: "edit", onClick: function () { return _this.setEditing(index, originalRow); } }),
    ...
    ApplicationRequestActivitiesTable.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", null,
            react_1.default.createElement(antd_1.Table, { columns: this.getColumns(), rowKey: function (r) { return r.activity.id.toString(); }, dataSource: this.props.applicationItems, pagination: false, footer: function () { return (react_1.default.createElement(antd_1.Button, { htmlType: "button", type: "primary", onClick: _this.onAdd, disabled: isInChangeState }, "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C")); } })));
    };
    return ApplicationRequestActivitiesTable;
}(react_1.default.Component));
exports.default = ApplicationRequestActivitiesTable;
