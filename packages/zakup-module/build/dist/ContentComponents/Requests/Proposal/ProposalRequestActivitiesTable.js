...
var ProposalRequestActivitiesTableSubRow_1 = __importDefault(require("./ProposalRequestActivitiesTableSubRow"));
            ...
            return [
                {
                    ...
                    render: function (data, originalRow, index) {
                        ...
                        return (react_1.default.createElement("div", { style: { display: 'flex', alignItems: 'center' } },
                            react_1.default.createElement(antd_1.Select, { value: _this.props.proposalItems[idInChange].activity.id, onChange: function (val) {
                                ...
                                return react_1.default.createElement(Option, { key: option.id }, option.name);
                            })),
                            react_1.default.createElement("div", { style: { display: 'flex', alignItems: 'center', marginLeft: '20px' } },
                                react_1.default.createElement(antd_1.Icon, { style: { color: '#1890ff', cursor: 'pointer' }, type: "check", onClick: _this.onAcceptNew }),
                                react_1.default.createElement(antd_1.Icon, { style: { color: '#1890ff', cursor: 'pointer', marginLeft: '5px' }, type: "close", onClick: _this.onCancel }))));
                    },
                },
                {
                    title: '',
                    ...
                    render: function (id, originalRow, index) {
                        ...
                        if (isExpanded) {
                            return (react_1.default.createElement("div", { style: { display: 'flex', alignItems: 'center' } },
                                react_1.default.createElement(antd_1.Icon, { style: { color: '#1890ff', cursor: 'pointer' }, type: "edit", onClick: function () { return _this.setEditing(index, originalRow.activity, originalRow.proposalItemValues); } }),
                                react_1.default.createElement(antd_1.Icon, { style: { color: '#1890ff', marginLeft: '5px', cursor: 'pointer' }, type: "delete", onClick: function () { return _this.onDelete(originalRow.activity.id); } })));
                        }
                        return null;
                    },
                },
    ...
    ProposalRequestActivitiesTable.prototype.render = function () {
        ...
        if (this.props.proposalItems.length) {
            expandedObj['expandedRowRender'] = function (r) {
                return (react_1.default.createElement(ProposalRequestActivitiesTableSubRow_1.default, { onProposalItemValueChange: _this.onProposalItemValueChange, proposalItem: r }));
            };
        }
        return (react_1.default.createElement("div", null,
            react_1.default.createElement(antd_1.Table, __assign({ size: "small", indentSize: 4, showHeader: false, title: function () { return 'Виды деятельности'; }, columns: this.getColumns(), rowKey: function (r) { return r.activity.id.toString(); }, dataSource: this.props.proposalItems, pagination: false }, expandedObj, { onExpandedRowsChange: this.handleExpandedRowsChange, footer: function () { return (react_1.default.createElement(antd_1.Button, { htmlType: "button", type: "primary", onClick: _this.onAdd, disabled: isInChangeState }, "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C")); } }))));
    };
    return ProposalRequestActivitiesTable;
}(react_1.default.Component));
exports.default = ProposalRequestActivitiesTable;
