...
var ProposalRequestInternalForm = antd_1.Form.create({
    ...
    mapPropsToFields: function (props) {
        return {
            ...
            periodYear: antd_1.Form.createFormField(__assign({}, props.periodYear, { value: props.periodYear.value ? props.periodYear.value.id : props.periodYearId || '' })),
            clinic: antd_1.Form.createFormField(__assign({}, props.clinic, { value: props.clinic.value ? props.clinic.value.id : '' })),
            region: antd_1.Form.createFormField(__assign({}, props.region, { value: props.region.value ? props.region.value.id : props.regionId || '' })),
            proposalType: antd_1.Form.createFormField(__assign({}, props.proposalType, { value: props.proposalType.value ? props.proposalType.value.id : '' })),
        };
    },
})(function (props) {
    ...
    return (React.createElement(antd_1.Form, { onSubmit: props.handleSubmit(props.form), style: { display: 'flex', flexDirection: 'column' } },
        ...
        React.createElement(FormItem, __assign({ style: { marginBottom: '0', flexShrink: 0 }, label: "\u0420\u0435\u0433\u0438\u043E\u043D \u043E\u0441\u0443\u0449\u0435\u0441\u0442\u0432\u043B\u0435\u043D\u0438\u044F \u0434\u0435\u044F\u0442\u0435\u043B\u044C\u043D\u043E\u0441\u0442\u0438" }, shared_1.CommonFormItemLayout), getFieldDecorator('region', {
            rules: [{ required: true, message: 'Поле обязательно для заполнения' }],
        })(React.createElement(antd_1.Select, { disabled: !!props.regionId }, props.regionsDict.map(function (option) {
        ...
        React.createElement(FormItem, __assign({ style: { marginBottom: '0', flexShrink: 0 }, label: "\u041F\u043B\u0430\u043D\u043E\u0432\u044B\u0439 \u043F\u0435\u0440\u0438\u043E\u0434" }, shared_1.CommonFormItemLayout), getFieldDecorator('periodYear', {
            rules: [{ required: true, message: 'Поле обязательно для заполнения' }],
        })(React.createElement(antd_1.Select, { disabled: !!props.periodYearId }, props.periodYearsDict.map(function (option) {
            return React.createElement(Option, { key: option.id }, option.year);
        })))),
        React.createElement(FormItem, __assign({ style: { marginBottom: '0', flexShrink: 0 }, label: "\u0412\u0438\u0434 \u0437\u0430\u044F\u0432\u043A\u0438" }, shared_1.CommonFormItemLayout), getFieldDecorator('proposalType', {
            rules: [{ required: true, message: 'Поле обязательно для заполнения' }],
        })(React.createElement(antd_1.Select, null, props.proposalTypesDict.map(function (option) {
            return React.createElement(Option, { key: option.id }, option.nameRu);
        })))),
...
exports.default = ProposalRequestInternalForm;
